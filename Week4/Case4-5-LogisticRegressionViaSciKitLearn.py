...
# load dataset
<<<<<<< HEAD
pima = pd.read_csv("/Users/haseebtariq/Documents/GitHub/FULLSTACK-WITH-AI-BOOTCAMP-B1-MonToFri-2.5Month-Explorer/Week4/diabetes.csv", header=1, names=col_names)
=======
